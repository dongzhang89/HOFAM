...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='./checkpoint/checkpoint{}'.format(dir_name), help='models are saved here')
parser.add_argument('--sample_dir', dest='sample_dir', default='./sample/sample{}'.format(dir_name), help='sample are saved here')
parser.add_argument('--test_dir', dest='test_dir', default='./test/test{}'.format(dir_name), help='test sample are saved here')
parser.add_argument('--log_dir', dest='log_dir', default='./logs_CD/log{}'.format(dir_name), help='test sample are saved here')
